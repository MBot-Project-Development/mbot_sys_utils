...
cd ~/mbot_workspace/mbot_sys_utils
...
# mbot_lcm_base
cd ~/mbot_workspace/mbot_lcm_base
...
# rplidar_lcm_driver
cd ~/mbot_workspace/rplidar_lcm_driver
...
# mbot_web_app
cd ~/mbot_workspace/mbot_web_app
...
# mbot_firmware
cd ~/mbot_workspace/mbot_firmware
...
# mbot_autonomy
cd ~/mbot_workspace/mbot_autonomy
